...
public class SnowflakeIdWorker {
    ...
    public synchronized long nextId(long placeHolder) {
        ...
        log.info("(timestamp - twepoch) = {}, {}", timestamp - twepoch, Long.toBinaryString(timestamp - twepoch));
        log.info("datacenterId          = {}, {}", datacenterId, Long.toBinaryString(datacenterId));
        log.info("workerId              = {}, {}", workerId, Long.toBinaryString(workerId));
        log.info("sequence              = {}, {}", sequence, Long.toBinaryString(sequence));
        log.info("placeHolder           = {}, {}", placeHolder, Long.toBinaryString(placeHolder));
